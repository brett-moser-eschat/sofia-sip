...
/**@ingroup su_root_ex
 * @CFILE su_cdlib_test.c
 *
 * @brief Test program for cdlib and su root event loop integration.
 *
 * @author Tarik Miller
 *
...
/* commented out for now because this test code needs to be updated for
   cdlib (copied from glib port as a basis to start from) */
#if 0
struct pinger;
