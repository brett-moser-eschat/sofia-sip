 ...
 *
 * Contact: Tarik Miller <tmiller@slacorp.tom>
 *
...
/**
 * @brief Test program for su-cdlib timers
 *
...
/* Commented out for now. this code needs to be updated for cdlib.
   (copied from glib as a basis to start from.) */
#if 0
#include "config.h"
